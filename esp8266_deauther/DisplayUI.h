...
const char D_INTRO_0[] PROGMEM = "ESP8266 Deauther remake";
const char D_INTRO_1[] PROGMEM = "by Nguyễn Trường";
const char D_INTRO_2[] PROGMEM = DISPLAY_TEXT;
const char D_RESETTING[] PROGMEM = "Đang reset...";
const char D_SCANNING_0[] PROGMEM = "> Đang tìm";
const char D_SCANNING_1[] PROGMEM = "> Đang tìm.";
const char D_SCANNING_2[] PROGMEM = "> Đang tìm..";
const char D_SCANNING_3[] PROGMEM = "> Đang tìm...";
